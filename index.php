...
<!--         end aside -->
        ...
        <div class="data span 10 clearfix">
          ...
          <dd>
              ...
              {{if scientific_name}}<dt>Wikispecies</dt><dd><a href="http://species.wikimedia.org/wiki/${scientific_name}" target="_blank"><em>${scientific_name} (in WikiSpecies)</em></a> var. <a href="http://species.wikimedia.org/wiki/${scientific_name}_var._${variety}" target="_blank">${variety}</a></dd>{{/if}}
