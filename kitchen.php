...
<!--         end aside -->
  ...
  <div id="foods" class="inner-transition">
    ...
    <div class="modal-header">
        ...
        <h3>Open Kitchen Techniques List</h3>
    </div>
    <div class="modal-body">
        <p><strong>This is a prototype</strong> of a tool to view and manage community contributed information about kitchen techniques.</strong></p>
        ...
        <dl>
          <dt>Techniques</dt><dd>Added new section, kitchen techniques.</dd>
        </dl>
    </div>
    </div>
